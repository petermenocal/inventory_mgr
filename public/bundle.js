...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 190, 6, 6159);
    			add_location(h1, file, 191, 6, 6188);
    			attr_dev(div1, "class", "w-full h-full flex flex-col items-center justify-center");
    			add_location(div1, file, 189, 4, 6083);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			tr = element("tr");
    			th0 = element("th");
    			th0.textContent = "Expired";
    			t1 = space();
    			th1 = element("th");
    			th1.textContent = "Expires";
    			t3 = space();
    			th2 = element("th");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td4, file, 165, 14, 5290);
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file, 174, 18, 5702);
    			...
    			add_location(a, file, 169, 16, 5472);
    			attr_dev(td5, "class", "text-center border px-2 py-2");
    			add_location(td5, file, 168, 14, 5414);
    			attr_dev(td6, "class", "text-left border px-2 py-2");
    			add_location(td6, file, 182, 14, 5930);
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*products*/ ctx[0].length) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			div0 = element("div");
    			div0.textContent = "Expired";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "Expiring within 30 days";
    			t3 = space();
    			if_block.c();
